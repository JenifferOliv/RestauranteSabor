// URLs das planilhas
const PLANILHA_ESTABELECIMENTO = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRdx4bstqDgK2vhPsf9mserVJbSlfF-huXmYyWG44OfB3tu-Rqbe9O2NKw86X9Eds7N7CbdfzD0WkXQ/pub?gid=0&single=true&output=csv';
const PLANILHA_CATEGORIAS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRdx4bstqDgK2vhPsf9mserVJbSlfF-huXmYyWG44OfB3tu-Rqbe9O2NKw86X9Eds7N7CbdfzD0WkXQ/pub?gid=790705008&single=true&output=csv';
const PLANILHA_ITENS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRdx4bstqDgK2vhPsf9mserVJbSlfF-huXmYyWG44OfB3tu-Rqbe9O2NKw86X9Eds7N7CbdfzD0WkXQ/pub?gid=1010575225&single=true&output=csv';
...
function desabilitarBotoesAdicionar() {
    ...
    botoes.forEach(botao => {
        if (!botao.disabled) {
            botao.disabled = true;
            botao.classList.remove('bg-pink-500', 'hover:bg-blue-600');
